...
<?php while ($category->next()): ?>
 ...
 ;?>" href="javascript:;" target="_self" title="All">All</a>
    ...
    ;?>" href="<?php echo $child['permalink'] ?>" target="_self" title="<?php echo $child['name']; ?>"><?php echo $child['name']; ?></a>
              ...
              <div class="secondary-nav-right">
                <button class="secondary-nav-fold-btn">
                  <span class="secondary-nav-fold-btn-unfurl">Expand</span>
                  <span class="secondary-nav-fold-btn-retract">Collapse</span>
